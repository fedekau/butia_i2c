...
void HackPointsConfigure(byte);

/* Table used by te framework to get a fixed reference point
 * to the user module functions defined by the framework
/** USER MODULE REFERENCE*****************************************************/
#pragma romdata user
const uTab HackPointsModuleTable = {&HackPointsInit, &HackPointsRelease, &HackPointsConfigure, "hackp"};
#pragma code
...
/******************************************************************************
/* Function:        HACK_POINTSConfigure(void)
 *
 * PreCondition:    None
 *
 * Input:           None
 ...
 * Note:            None
 *****************************************************************************/
void HackPointsConfigure(byte handler) {
}
