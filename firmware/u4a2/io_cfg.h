...
/** AFE IO configuration ********************************************/
#define mInitAFE TRISA=0xFF;TRISB=0x10;TRISD=0x80;LATBbits.LATB5=0;LATBbits.LATB0=0;LATBbits.LATB1=0;LATBbits.LATB6=0;LATBbits.LATB2=0 //ver redmvd/documentacion/usb4all/pinout.ods firmware para AFE
#define mInitReloj TRISA=0xFF;TRISB=0x00;TRISD=0x80; //ver redmvd/documentacion/usb4all/pinout.ods firmware para reloj
/** L E D ***********************************************************/
...
#define mInitPortC() TRISC= TRISC | 0XCF; //is a good practice to set unused pins to input
...
#define mInitLeds()  TRISB=TRISB&0xBC;
...
#define mLED_N_Off(N)       mLED_ ## N = 0;
//#define mLED_4_Off()        mLED_4 = 0;

#define mLED_1_Toggle()     mLED_1 = !mLED_1;
#define mLED_2_Toggle()     mLED_2 = !mLED_2;
#define mLED_3_Toggle()     mLED_3 = !mLED_3;
#define mLED_N_Toggle(N)    mLED_ ## N = !mLED_ ## N;
...
///#define mInitBuzzer()  	    TRISBbits.TRISB5=0;LATBbits.LATB5=0;
#define mInitBuzzer()  	    TRISB = TRISB&0xDF;
...
#define MOVE_SENSOR         PORTDbits.RD7
#define mInitMoveSensor()   TRISDbits.TRISD7=1;
...
/** PIRS *************************************************************/
#define mInitSecSensor()	TRISDbits.TRISD7=1;TRISAbits.TRISA4=1;
